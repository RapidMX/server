 ...
 * (via `transport_maps` - see docker-compose.mail.yml) once its own recipient-validation checks
 ...
 * from the deployment's own Postfix container (see docker-compose.mail.yml's `transport_maps` wiring);
