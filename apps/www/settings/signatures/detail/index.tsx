...
import { MailSignature, getMailSignature, listMailSignatures, updateMailSignature } from "../../../../shared/lib/mailSignaturesApi.js";
...
/** This framework has no dynamic route segments — the target signature's uid comes from the query
...
export type SignatureDetailPageProps = Omit<SettingsShellProps, "active">;
...
function SignatureDetailContent() {
    ...
    if (!uid) {
        return <Alert>No signature specified.</Alert>;
    }
    if (loading) {
