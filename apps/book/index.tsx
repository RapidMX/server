...
/** This framework has no dynamic route segments — the booking type's slug comes from the query string
 * instead (`/book?slug=intro-call`), same convention as every other detail page in this project. */
