...
import MessageDetailPage, { readTargetUid } from "../../../../apps/www/messages/detail/index.js";

describe("MessageDetailPage SSR guard (no window)", () => {
    it("renders without throwing when there is no window global", () => {
        expect(typeof window).toBe("undefined");
        expect(() => renderToStaticMarkup(<MessageDetailPage userUid="u1" />)).not.toThrow();
    });
