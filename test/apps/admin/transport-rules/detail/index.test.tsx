...
import TransportRuleDetailPage from "../../../../../apps/admin/transport-rules/detail/index.js";
...
beforeEach(() => {
    window.history.pushState(null, "", "/admin/transport-rules/detail?uid=tr1");
});
...
describe("TransportRuleDetailPage", () => {
    it("shows an alert when no uid is given", async () => {
        window.history.pushState(null, "", "/admin/transport-rules/detail");
        mockFetch(() => jsonResponse(200, {}));
        render(<TransportRuleDetailPage userUid="admin-1" authServerUrl="https://auth.example.com" />);
        expect(await screen.findByText("No transport rule specified.")).toBeInTheDocument();
    });
