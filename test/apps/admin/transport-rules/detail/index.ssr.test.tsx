...
import TransportRuleDetailPage, { readTargetUid } from "../../../../../apps/admin/transport-rules/detail/index.js";

describe("TransportRuleDetailPage SSR guard (no window)", () => {
    it("renders without throwing when there is no window global", () => {
        expect(typeof window).toBe("undefined");
        expect(() => renderToStaticMarkup(<TransportRuleDetailPage userUid="admin-1" />)).not.toThrow();
    });
