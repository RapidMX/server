...
import DistributionListDetailPage, { readTargetUid } from "../../../../../apps/admin/distribution-lists/detail/index.js";

describe("DistributionListDetailPage SSR guard (no window)", () => {
    it("renders without throwing when there is no window global", () => {
        expect(typeof window).toBe("undefined");
        expect(() => renderToStaticMarkup(<DistributionListDetailPage userUid="admin-1" />)).not.toThrow();
    });
