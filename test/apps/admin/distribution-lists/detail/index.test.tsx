...
import DistributionListDetailPage from "../../../../../apps/admin/distribution-lists/detail/index.js";
...
beforeEach(() => {
    window.history.pushState(null, "", "/admin/distribution-lists/detail?uid=team%40example.com");
});
...
describe("DistributionListDetailPage", () => {
    it("shows an alert when no uid is given", async () => {
        window.history.pushState(null, "", "/admin/distribution-lists/detail");
        mockFetch(() => jsonResponse(200, {}));
        render(<DistributionListDetailPage userUid="admin-1" authServerUrl="https://auth.example.com" />);
        expect(await screen.findByText("No distribution list specified.")).toBeInTheDocument();
    });
