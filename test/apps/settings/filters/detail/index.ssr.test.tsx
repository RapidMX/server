...
import MailFilterDetailPage, { readTargetUid } from "../../../../../apps/www/settings/filters/detail/index.js";

describe("MailFilterDetailPage SSR guard (no window)", () => {
    it("renders without throwing when there is no window global", () => {
        expect(typeof window).toBe("undefined");
        expect(() => renderToStaticMarkup(<MailFilterDetailPage userUid="u1" />)).not.toThrow();
    });
