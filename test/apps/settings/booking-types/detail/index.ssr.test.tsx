...
import BookingTypeDetailPage, { readTargetUid } from "../../../../../apps/www/settings/booking-types/detail/index.js";

describe("BookingTypeDetailPage SSR guard (no window)", () => {
    it("renders without throwing when there is no window global", () => {
        expect(typeof window).toBe("undefined");
        expect(() => renderToStaticMarkup(<BookingTypeDetailPage userUid="u1" />)).not.toThrow();
    });
