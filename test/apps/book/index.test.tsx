...
import PublicBookingPage from "../../../apps/book/index.js";
...
beforeEach(() => {
    window.history.pushState(null, "", "/book?slug=intro-call");
});
...
describe("PublicBookingPage", () => {
    it("shows an alert when no slug is given", async () => {
    ...
    it("selects a slot, submits the booking form, and shows a confirmation with the manage link", async () => {
        ...
        expect(screen.getByRole("link", { name: /book\/manage\?token=tok123/ })).toBeInTheDocument();
    });
