...
import ContactDetailPage from "../../../../apps/www/contacts/detail/index.js";
...
beforeEach(() => {
    window.history.pushState(null, "", "/contacts/detail?uid=c1");
});
...
describe("ContactDetailPage", () => {
    it("shows an alert when no uid is given", async () => {
        window.history.pushState(null, "", "/contacts/detail");
        mockShell();
        render(<ContactDetailPage userUid="u1" />);
        expect(await screen.findByText("No contact specified.")).toBeInTheDocument();
    });
